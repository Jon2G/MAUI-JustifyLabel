...
namespace JustifyLabel.Platforms.Windows;
...
public class JustifiedLabelHandler : JustifyLabel.JustifiedLabelHandler
{
    ...
    public static void SetPlatformProperties(ILabelHandler? handler, ILabel? label)
    {
        ...
        {
            handler.PlatformView.TextAlignment = isJustified ? Microsoft.UI.Xaml.TextAlignment.Justify : Microsoft.UI.Xaml.TextAlignment.Left;
        }
